...
const expectedFailures = new Map([
  ...
  ['FieldKeyEdit after a successful response refreshes the list of app users', expected('VG replaces the upstream FieldKey list and row components.', 'Unable to get .field-key-row .edit-button')],
  ['FieldKeyEdit after a successful response shows a success message', expected('VG replaces the upstream FieldKey list and row components.', 'Unable to get .field-key-row .edit-button')],
  ['FieldKeyEdit after a successful response updates the list of actor properties', expected('VG replaces the upstream FieldKey list and row components.', 'Unable to get .field-key-row .edit-button')],
  ...
  ['FieldKeyNew list of actor properties updates the list after the app user is created', expected('VG replaces the upstream FieldKey list and new component.', 'Unable to get .actor-properties-new')],
  ['FieldKeyNew list of actor properties updates the list if only the property request succeeds', expected('VG replaces the upstream FieldKey list and new component.', 'Unable to get .actor-properties-new')],
  ['FieldKeyNew list of actor properties updates the list after multiple app users are created', expected('VG replaces the upstream FieldKey list and new component.', 'Unable to get .actor-properties-new')],
