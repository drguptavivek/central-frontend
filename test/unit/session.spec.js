  ...
  describe('logout after inactivity', () => {
    ...
    it('shows warning 3 minutes before inactivity timeout', () => {
      ...
      return mockHttp(container)
        ...
        .complete()
        .testNoRequest(() => {
          // Advance to 27 minutes (3 minutes before 30-minute timeout)
    ...
    it('resets warning after activity', () => {
      ...
      return mockHttp(container)
        ...
        .afterResponse(() => {
          ...
          // Simulate activity
          window.dispatchEvent(new Event('mousemove'));
          clock.tick(15000); // Allow throttle to process
        })
        .testNoRequest(() => {
          // Advance to warning threshold again
          clock.tick(inactivityLogoutMillis - 180000);
        })
        .afterResponse(() => {
          // Warning should be shown again after activity reset
    ...
    it('prevents logout when activity detected from other tabs', () => {
      ...
      return mockHttp(container)
        ...
        .testNoRequest(() => {
          ...
          // Simulate activity in another tab by updating localStorage and triggering storage event
          const now = Date.now();
        ...
        .afterResponse(() => {
          // Should not log out because of activity from other tab
          session.dataExists.should.be.true;
        });
    });
  });
